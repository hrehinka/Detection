...
img_text_removed = inpaint_text('D:/Diploma thesis/Dataset/CVC-FP/Images/p1.jpg', pipeline)

plt.imshow(img_text_removed)

cv2.imwrite('D:/Diploma thesis/Dataset/CVC-FP/Images/p1_separated.png', cv2.cvtColor(img_text_removed, cv2.COLOR_BGR2RGB))